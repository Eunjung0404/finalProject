...
<style type="text/css">
	...
	tr, th, td{border:solid 1px #BDBDBD; text-align:center; background-color:white;}
	
	#pageing{margin:auto;}
	
	h1{text-align:center; padding: 20px 0 5px;}
	
	#insert{ margin:6px auto; display:block; background-color: #196ab3; min-width: 70px; 
			border: none; line-height: 30px; color: #ffffff; cursor: pointer; margin-bottom: 30px;
	}
</style>
</head>
<body>
<div id="backgroundColor">
	...
	<button type="button" id="insert" onclick="location.href='${cp }/admin/movie/movieinsert'">영화 등록하기</button>
</div>
</body>
</html>